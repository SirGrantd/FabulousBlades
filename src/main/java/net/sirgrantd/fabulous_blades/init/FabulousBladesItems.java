...
import net.sirgrantd.fabulous_blades.common.items.weapons.legendarys.DancersWish;
import net.sirgrantd.fabulous_blades.common.items.weapons.legendarys.EveOfDawnItem;
import net.sirgrantd.fabulous_blades.common.items.weapons.legendarys.HealtheaterItem;
import net.sirgrantd.fabulous_blades.common.items.weapons.legendarys.JudgmentFlame;
...
public class FabulousBladesItems {
	...
	public static final DeferredItem<Item> HEALTHEATER = REGISTRY.register("healtheater", HealtheaterItem::new);
	public static final DeferredItem<Item> EVE_OF_DAWN = REGISTRY.register("eve_of_dawn", EveOfDawnItem::new);
	public static final DeferredItem<Item> DANCERS_WISH = REGISTRY.register("dancers_wish", DancersWish::new);
	public static final DeferredItem<Item> JUDGMENT_FLAME = REGISTRY.register("judgment_flame", JudgmentFlame::new);
