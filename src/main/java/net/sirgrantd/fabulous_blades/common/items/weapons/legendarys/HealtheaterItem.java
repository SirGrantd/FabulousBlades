...
public class HealtheaterItem extends FabulousWeapons {
    ...
    private static final float ATTACK_DAMAGE = 11f;
    private static final float ATTACK_SPEED = -2.6f;
    private static final float CRIT_CHANCE = 0.15f;
    private static final float CRIT_DAMAGE = 0;

    public HealtheaterItem() {
